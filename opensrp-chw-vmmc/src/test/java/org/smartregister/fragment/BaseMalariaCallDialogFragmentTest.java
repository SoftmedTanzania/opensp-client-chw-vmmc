...
public class BaseVmmcCallDialogFragmentTest {
    @Spy
    public BaseVmmcCallDialogFragment baseVmmcCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseVmmcCallDialogFragment.class, "MEMBER_OBJECT", memberObject);
    }
    ...
    public void setCallTitleFamilyHead() throws Exception {
        ...
        Whitebox.invokeMethod(baseVmmcCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
    ...
    public void initUI() throws Exception {
        ...
        Whitebox.invokeMethod(baseVmmcCallDialogFragment, "initUI", viewGroup);
        PowerMockito.verifyPrivate(baseVmmcCallDialogFragment).invoke("setCallTitle", viewGroup, view.getId(), "message");
