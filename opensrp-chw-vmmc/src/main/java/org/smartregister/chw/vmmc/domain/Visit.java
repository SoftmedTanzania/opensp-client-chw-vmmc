...
public class Visit {
    ...
    private Map<String, List<org.smartregister.chw.vmmc.domain.VisitDetail>> visitDetails = new HashMap<>();
    ...
    public Map<String, List<org.smartregister.chw.vmmc.domain.VisitDetail>> getVisitDetails() {
        return visitDetails;
    }

    public void setVisitDetails(Map<String, List<org.smartregister.chw.vmmc.domain.VisitDetail>> visitDetails) {
