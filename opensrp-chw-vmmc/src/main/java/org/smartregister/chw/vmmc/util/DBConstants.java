...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String DATE_CHW_VMMC_TEST = "date_chw_vmmc_test";
        public static final String FEVER_VMMC_CHW = "fever_vmmc_chw";
        public static final String FEVER_DURATION = "fever_duration";
        public static final String VMMC_RESULTS = "vmmc_results";
        public static final String DATE_HF_VMMC_TEST = "date_hf_vmmc_test";
        public static final String VMMC_TEST_DATE = "vmmc_test_date";
        public static final String VMMC_TREAT = "vmmc_treat";
        ...
        public static final String VMMC_EDU_CHW = "vmmc_edu_chw";
        ...
        public static final String PHONE_NUMBER_VMMC = "phoneNumberVmmc";
        public static final String GEST_AGE = "gest_age";
        public static final String DELIVERY_DATE = "delivery_date";
        public static final String VMMC_FOLLOW_UP_DATE = "date_chw_mfollowup";
